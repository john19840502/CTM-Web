  ...
  builder.INTEREST_CALCULATION do
    builder.INTEREST_CALCULATION_RULES do
      builder.INTEREST_CALCULATION_RULE do
        builder.InterestCalculationPeriodType loan['InterestCalculationPeriodType']
        builder.InterestCalculationType loan['InterestCalculationType']
      end
    end
  end
  ...
  builder.UNDERWRITING do
    builder.AUTOMATED_UNDERWRITINGS do
      builder.AUTOMATED_UNDERWRITING do
        ...
        builder.AutomatedUnderwritingSystemTypeOtherDescription loan.AutomatedUnderwritingSystemTypeOtherDescription
      end
    end

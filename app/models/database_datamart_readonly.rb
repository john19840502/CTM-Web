class DatabaseDatamartReadonly < ActiveRecord::Base
  self.abstract_class = true

  def self.primary_key
    'id'
  end
  #using_access_control - Commented out 8/8/2012 - CTMWEB-403
  ...
  def self.datamart_classes
    Dir.glob("#{Rails.root}/app/models/**/*.rb").each { |file| require file }
    self.descendants + DatabaseDatamart.descendants
  end
  ...
  def self.run_model_scripts(affect_database = true)
    ...
    datamart_classes.each do |klass|

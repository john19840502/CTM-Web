class Closing::LoanModelerPreTridsController < ApplicationController
  ...
  def search
    ...
    if id.present?
      ...
      redirect_to closing_loan_modeler_pre_trids_path
    end
  end
  ...
  def show
    ...
    if @loan.nil? || !(can? :manage, Loan)
      ...
      redirect_to closing_loan_modeler_pre_trids_path and return
    else
  ...
  def submit
    loan = Loan.find_by_loan_num(params[:loan_id])

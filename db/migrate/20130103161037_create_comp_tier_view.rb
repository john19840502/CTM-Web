class CreateCompTierView < ActiveRecord::Migration
  def up
    if Rails.env.development?
      execute <<-SQL_table
        CREATE TABLE ctm.Comp_Tier
        (
        ID int NOT NULL PRIMARY KEY, 
        Institution_Number varchar(20),
        Channel_Mortgage_Type varchar(2),
        Comp_Tier decimal(7,5),
        Effective_Date datetime, 
        CTM_Institution_Number varchar(20),
        Maximum_Compensation money,
        Minimum_Compensation money,
        FHA_Approved varchar(1),
